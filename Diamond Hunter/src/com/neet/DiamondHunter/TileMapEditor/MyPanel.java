...
// This Panel is used only in "App.java", the swing version of Tile Map Editor
// "App_JavaFX" makes no use of this class/has no dependency on this class
// to do: some methods from this class will also be reused in "App_JavaFX" to draw the map
public class MyPanel extends JPanel implements Runnable, KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
	...
	private String path = "/tileset/tileset.gif";
	...
	private void loadTileSet(String s) {
		...
		try {
			...
			tileset = ImageIO.read(new File(getClass().getResource(s).toURI()));
